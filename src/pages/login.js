...
export const Login = () => {
    ...
    return (
        <div className="container mt-1">
            ...
            <button onClick={signInWithGithub} className="btn btn-dark"> <svg xmlns="http://www.w3.org/2000/svg" width="25" height="30" fill="currentColor" className="bi bi-github me-1" viewBox="0 0 16 16">
